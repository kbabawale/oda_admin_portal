<div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-user-md"></i> User Accounts
    ...
    <div class="card-body">
      <!-- <div class="container mb-3">
        <div class="row">
          <form id="searchform" style="width:100%;" class="form-inline">
            <div class="col-md-4">
                
                <input type="text" class="form-control my-2 mr-sm-2" style="width:100%;" name="name" id="name" placeholder="Name">
            </div>
            <div class="col-md-3">
                
                <select class="form-control custom-select my-2 mr-sm-2" style="width:100%;" name="vendorselect" id="vendorselect">
                    <option value="0" selected>All User Types</option>
                    <option value="0">Delivery Rep</option>
                    <option value="0">Merchant</option>
                </select>
            </div>
            <div class="col-md-3">
                
                <select class="form-control custom-select my-2 mr-sm-2" style="width:100%;" name="referal" id="referal">
                    <option value="0" selected>No Referral Code</option>
                </select>
            </div>
            <div class="col-md-2">
                <button id="searchbtn" type="button" style="width:100%;" class="pull-right btn btn-success my-2">Search</button>
            </div>
          </form>
        </div>
      </div> -->
